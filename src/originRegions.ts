...
export const originZones: Record<string, OriginZone> = {
  ...
  'american-saddlebred': circle('Kentucky and the Bluegrass region', 'A broad zone covers the Kentucky Saddler heartland and neighboring breeding country.', 38.05, -84.50, 300),
  'american-curly': circle('Great Basin range country', 'The wide full-score zone reflects the western range herds central to the modern breed story.', 39.53, -115.97, 520),
  'canadian-horse': circle('St. Lawrence Valley', 'A generous corridor covers the early settlements of New France rather than one modern city.', 46.81, -71.21, 560),
  criollo: manualPolygon('Pampas of Argentina and Uruguay', 'The broad grassland homeland on both sides of the Río de la Plata receives full credit.', [[-65, -28], [-51, -28], [-51, -40], [-64, -40]]),
  'paso-fino': manualPolygon('Puerto Rico and the northern Colombian tradition', 'The broad Caribbean zone accepts either of the breed’s best-known regional traditions.', [[-78, 20], [-64, 20], [-64, 16], [-70, 13], [-74, 8], [-78, 10]]),
  brumby: circle('Australian Alps and southeastern ranges', 'A generous zone recognizes a famous Brumby heartland while allowing for its wide-ranging feral populations.', -36.45, 148.27, 520),
  barb: manualPolygon('The Maghreb', 'The North African homeland from Morocco through Tunisia receives full credit.', [[-13, 37], [12, 37], [12, 28], [-13, 28]]),
  'don-horse': circle('Lower Don steppe', 'A broad steppe zone follows the Don Cossack homeland rather than requiring one stud.', 47.24, 39.71, 380),
  jutland: circle('Jutland Peninsula', namedRegion, 56.16, 9.25, 280),
  'welsh-cob': circle('Wales', broadHomeland, 52.30, -3.74, 260),
  'new-forest-pony': circle('New Forest, Hampshire', namedRegion, 50.86, -1.62, 95),
  'dartmoor-pony': circle('Dartmoor, Devon', namedRegion, 50.57, -3.92, 105),
  'jeju-horse': circle('Jeju Island', 'The island and its immediate waters receive full credit.', 33.38, 126.53, 90),
  mustang: manualPolygon('Western United States', 'The full-score area covers the broad western range where managed Mustang herds live.', [[-125, 49], [-102, 49], [-102, 31], [-117, 31], [-125, 42]]),
  'rocky-mountain-horse': circle('Eastern Kentucky and the Appalachian foothills', 'A broad regional zone recognizes the breed’s actual Kentucky development despite its name.', 37.78, -83.68, 280),
  'florida-cracker': circle('Florida', 'The whole peninsula and panhandle receive full credit for this statewide landrace.', 28.10, -81.63, 500),
  waler: circle('New South Wales', 'A broad zone recognizes the colonial state most closely associated with the Waler name.', -32.16, 147.02, 720),
  'namib-desert-horse': circle('Garub plains near Aus', 'A focused zone covers the isolated desert herd’s documented range.', -26.66, 16.07, 160),
